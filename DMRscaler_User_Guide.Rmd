...
## get_loc_fdr_pval permutations can take a while... consider using more liberal fdr threshold for estimation of pval_cutoff OR manually setting pval_cutoff. 
pcut_table <- get_loc_fdr_pval(B, cases,controls, wilcox.test, fdr=0.05, return_table = T)
pval_cutoff <- 0.05
```
